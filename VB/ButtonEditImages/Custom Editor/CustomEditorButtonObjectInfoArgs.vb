...
Namespace ButtonEditImages
    ...
    Public Class CustomEditorButtonObjectInfoArgs
        ...
        Public Overrides ReadOnly Property IsImageExists As Boolean
            Get
                Dim lIsImageExists As Boolean = MyBase.IsImageExists
                If lIsImageExists Then Return lIsImageExists
                If Button.Kind <> ButtonPredefines.Glyph Then Return False
        ...
        Public Overrides ReadOnly Property ImageSize As Size
            Get
                ...
                If size.IsEmpty AndAlso IsImageExists Then Return CustomImage.Size
                Return size
            End Get
        End Property
